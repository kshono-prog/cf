...
Creator Founding の方向性・責任境界・実装優先順位をそろえるための入口です。
...
- `Constitution`: 何を守るか
- `Roadmap`: どの順番で進むか
- `Execution Plan`: 短期・中期・長期で何を実装するか
- `Project State`: 現在地と直近優先事項
- `Tasks`: 今すぐ着手する実装単位
- `Architecture`: 画面・責務・境界
- `Domain Model`: 用語とモデルの意味
...
5. Creator Home / Manager Desk specs
6. Architecture / Domain Model
7. Project State / Tasks
