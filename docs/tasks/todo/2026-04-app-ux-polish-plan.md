...
| [UXF-3](2026-04-uxf3-mobile-section-band-and-avatar-circle.md) | mobile section の full-width 化と avatar 円形維持 | 共通 UI foundation | ✅ 完了（2026-04-04） | UXF-2 |
| [UXF-4](2026-04-uxf4-line-divided-professional-sections.md) | line-divided section language で professional 化 | 共通 UI foundation | ✅ 完了（2026-04-04） | UXF-3 |
