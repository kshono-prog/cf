  ...
  if (!src || broken) {
    return (
      <div
        ...
        className="flex items-center justify-center rounded-full bg-gradient-to-br from-slate-400 to-sky-500 text-white ring-2 ring-[var(--line)] select-none font-semibold"
        aria-label={alt}
      >
        {fallbackText}
      </div>
