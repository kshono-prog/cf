...
export function ReplyComposer(props: Props) {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-4">
      ...
      <textarea
        className="input mt-2 min-h-[96px] w-full"
        value={value}
      ...
      <div className="mt-3 flex items-center justify-between gap-3">
        ...
        <button
          type="button"
          className="rounded-full bg-slate-950 px-4 py-2 text-xs font-semibold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-gray-300"
          onClick={onSubmit}
