...
export function CreatorReadyDailyBriefingHero(props: Props) {
  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-slate-200 bg-[linear-gradient(135deg,#f8fbff_0%,#ffffff_55%,#f3f7f3_100%)] shadow-sm">
      <div className="space-y-6 p-5 sm:p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-3xl space-y-4">
            <div className="flex flex-wrap items-center gap-2 text-[11px] font-semibold tracking-[0.14em] text-slate-500">
              <span>AI OFFICE HOME</span>
              <span className="rounded-full border border-slate-200 bg-white px-2.5 py-1 text-[10px] tracking-normal text-slate-700">
                {statusLabel}
              </span>
            </div>
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                  <div className="rounded-2xl bg-slate-950 px-4 py-3 text-white">
                    <div className="text-[11px] text-slate-300">進捗</div>
                    <div className="mt-1 text-2xl font-semibold">{progressPct}%</div>
                  </div>
                  <div className="rounded-2xl bg-slate-100 px-4 py-3 text-slate-900">
                    <div className="text-[11px] text-slate-500">現在の支援額</div>
                    <div className="mt-1 text-sm font-semibold">{supportLabel}</div>
                  </div>
                  <div className="rounded-2xl bg-slate-100 px-4 py-3 text-slate-900">
                    <div className="text-[11px] text-slate-500">投稿数</div>
          ...
          <div className="w-full max-w-md rounded-2xl border border-white/80 bg-white/90 p-4 shadow-sm">
              ...
              {priorityItems.map((item, index) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <span className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white text-xs font-semibold text-slate-700 shadow-sm">
                      {index + 1}
                    </span>
                    <div>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <a href={props.aiOfficeHref} className="btn-secondary">
                {aiOfficeLabel}
              </a>
              <a
                href={props.publicPageHref}
                target="_blank"
